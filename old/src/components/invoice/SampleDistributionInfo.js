          ...
          <td className="no-print">
            <button
              ...
              onClick={() => {
                axios
                  .post(
                    "http://localhost:8080/pharmacyproject/backend/invoice_module/specific_distribution_edit_data.php",
                    [
                      {
          ...
          <td className="no-print">
            <button
              ...
              onClick={() => {
                axios
                  .post(
                    "http://localhost:8080/pharmacyproject/backend/invoice_module/specific_distribution_delete_data.php",
                    el.dis_id
                  )
                  .then((res) => {
                    if (res.data.status) {
