...
if (!empty($customer_id)) {
    ...
    $query = "INSERT INTO invoice_p(invoice_id,customer_id,book_page_no,user_id,visitor_id,total_amount,invoice_date,status) values (default,'$customer_id','$book_page_no','$user_id','$visitor_id','$total_amount','$invoice_date','$status') ";
    ...
    if ($con->query($query) === TRUE) { //start of new
        ...
        //     $status = "sold";
        //     $query .= "(default,'$medicineId','$pack_quantity','$sell_price','$discount','$last_id','$status',null) ";
        //     $result = $con->query($query);
        //     array_push($invoice_ids, $con->insert_id);
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $newQuery = "SELECT loose_stock_id, quantity , sold_quantity FROM loose_stock_p WHERE medicine_id='$medicineId' AND status='added'";
            ...
            if ($newAmount <= $resultQuantity) {
                ...
                $sell_price = $data[$i]['sellPrice'];
                $discount = $data[$i]['discount'];
                $query .= "(default,'$medicineId','$newAmount','$sell_price','$discount','$last_id','sold','$last_loose_stock_id') ";
                $result = $con->query($query);
                //END NEWPART 
...
echo json_encode(array("status" => FALSE, "modal" => FALSE));
