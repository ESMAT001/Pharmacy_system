...
if($se['discount']===0){
$total+=(($se['cost_price']*$se['sold_quantity'])-($se['sell_price']*$se['sold_quantity']));
}else{

$total+=((($se['cost_price']*$se['sold_quantity'])-($se['sell_price']-($se['sell_price']*$se['discount']/100))*$se['sold_quantity']));
