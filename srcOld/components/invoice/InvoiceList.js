  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <table className="text-center" cellPadding="5px">
            ...
            <thead>
              ...
              <tr className="">
                <th className=""><button className="bg-blue-400  text-white hover:bg-blue-500 font-semibold px-2 py-1 rounded-md" onClick={() => returnItemHandlerSubmit()}>Return Medicine Double Click</button></th>
              </tr>
      ...
      >
        ...
        <div className="flex flex-row ">
          ...
          <div className="w-3/5  ">
            <div className="space-y-2 text-center w-3/4">
              <p className="text-2xl font-semibold ">شرکت صحت زعفران لمیتد</p>
        ...
        <div id="addressdetails" className="bg-blue-500 mt-5 p-2 flex flex-row justify-around hidden" dir="rtl">
