...
function AddToLooseStock() {
    ...
    const [getMedicineName, setGetMedicineName] = useState("");
 ...
 useEffect(() => {
    ...
    const [getMedicineId, setGetMedicineId] = useState("")
...
{ medicineList.length >0 &&
            <table className="border-2 w-full text-center" cellPadding="5px"  border="2px">
