        ...
        <div>
            ...
            <div className="p-4 bg-white shadow-lg rounded-lg">
               <form className="text-center" onSubmit={formHandler}>
                ...
                <select  className="border-2 font-bold focus:outline-none border-blue-400 rounded-md w-52 px-3 py-1 mx-2 " onChange={(e)=>setCustomerId(e.target.value)}  required>
                ...
                <input type="Date" onChange={(e)=>setDate(e.target.value)} className="border-2 w-52 border-blue-200 m-4 rounded-md px-2 py-1 focus:outline-none "  placeholder="Recipt Date" />
